...
["Este servidor restarta a cada 4 horas para garantir o desempenho do cliente", 750],
...
["Há Gun Stores Clandestinas não marcadas no mapa que mudam de posição a cada restart.Se acha-las,aproveite.", 1300]
