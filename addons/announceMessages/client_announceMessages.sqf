...
["Este servidor restarta a cada 4 horas para garantir o desempenho do cliente.", 630],
["Horários do restart: 00,04,08,12,16,20 (Hora de Brasília)", 907],//
//["Uso de Hack/Meios ilicitos = BAN PERMA", 674], 
