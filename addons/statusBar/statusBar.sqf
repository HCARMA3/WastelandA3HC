///////////////////////////////////////
// This script has bits in it from   //
// everywhere so credit to everyone! //
// Edited: by Matt76 @CCG            //
///////////////////////////////////////
...
CCG_StatusEnabled = true;

while {true} do
{	
	if !(CCG_StatusEnabled) then
	{
	...
	else
	{
		...
		_wallet = player getVariable ["hediw0lajki1evbnmuwwhhjj3",0] call fn_numbersText;
		...
		format
		["
			<t shadow='1' shadowColor='#000000' color='%9'><img size='1.0'  shadowColor='#000000' image='addons\statusbar\icons\players.paa' color='%9'/> %2</t>
			...
			<t shadow='1' shadowColor='#000000' color='%9'><img size='1.0'  shadowColor='#000000' image='addons\statusbar\icons\restart.paa' color='%9'/>%12:%13</t>",
