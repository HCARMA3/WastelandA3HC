...
//Also, presently, these are NON-Persistant vehicles.  Meaning that they will not last over a restart.  Keep that in mind with prices.  Later updates I'll set that up, with pin code entry.
	["Vehicles Armed",
		[
			["Strider HMG",			"I_MRAP_03_hmg_F",					45000,		"vehicle"],
			["Prowler HMG",			"B_T_LSV_01_armed_F",				45000,		"vehicle"],
			["Qilin Minigun",		"O_T_LSV_02_armed_F",				40000,		"vehicle"]
			//["MSE-3 Marid",			"O_APC_Wheeled_02_rcws_F",			67500,		"vehicle"],
			//["ZSU-39 Tigris",		"O_APC_Tracked_02_AA_F",			255000,		"vehicle"],
			//["MBT-52 Kuma",			"I_MBT_03_cannon_F",				480000,		"vehicle"]
		]
	],
	...
	["Vehicles Unarmed",
		[
			...
			["Strider",				"I_MRAP_03_F",						13000,		"vehicle"],
			["Ifrit",				"O_MRAP_02_F",						13000,		"vehicle"],
			...
			//["Tempest Repair",		"O_Truck_03_repair_F",				85000,		"vehicle"]
		]
	],	
	
	["Boats Armed",
		[
			["Speedboat Minigun",	"I_Boat_Armed_01_minigun_F",		15000,		"vehicle"],
			["Speedboat HMG", 		"O_Boat_Armed_01_hmg_F",			15500,		"vehicle"]
		]
	],
	...
	["Boats Unarmed",
		[
			...
			["Motorboat Police",	"C_Boat_Civil_01_police_F",			7000,		"vehicle"],
			["Assault Boat",		"B_G_Boat_Transport_01_F",			5000,		"vehicle"],
			["Water Scooter", 		"C_Scooter_Transport_01_F",			4000,		"vehicle"],
			["Motorboat",			"C_Boat_Civil_01_F",				4500,		"vehicle"]
		]
	],	

	["Weapons",
		[
			["Sniper Rifles",		"airdrop_Snipers",					120000,		"supply"],
			["DLC Rifles",			"airdrop_DLC_Rifles",				180000,		"supply"],
			["DLC LMGs",			"airdrop_DLC_LMGs",					120000,		"supply"],
			["Launchers",			"airdrop_USLaunchers",				100000,		"supply"],
			["Divers",				"airdrop_Divers",					60000,		"supply"],
			["Ammo Box",			"airdrop_AMMO",						100000,		"supply"]
		]
	]
];
...
APOC_AA_Drop_Contents =[
	["airdrop_Snipers",  //Name of the drop
		...
		// Valid item types: wep, itm, or bac.
			...
			["wep", ["srifle_DMR_01_F"],		1, 3],
			["wep", ["srifle_EBR_F"],	1, 3],
	...
	["airdrop_DLC_LMGs",
		[
			["wep", ["MMG_02_black_F", "MMG_02_camo_F","MMG_02_sand_F"], 4,4],
			["itm", ["V_PlateCarrierIAGL_dgtl", "V_TacVest_camo", "V_PlateCarrierGL_rgr"], 2],
			["bac", ["B_Carryall_mcamo", "B_Kitbag_mcamo"], 2],
	...
	["airdrop_USLaunchers",		
		[
			// Item type, Item class(es), # of items, # of magazines per weapon
			["wep", ["Rangefinder", "Rangefinder", "Rangefinder"], 1],
			["wep", ["launch_RPG32_F", "launch_NLAW_F", "launch_Titan_F"], 8, 4],
