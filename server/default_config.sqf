...
A3W_bountyMax = 455000;            // Maximum amount of money that can be set as a bounty on someone
A3W_bountyMinStart = 15000;        // Minimum amount of money to start a bounty on someone
...
A3W_mineLifetime = 6*24;           // Maximum lifetime in hours for saved mines across server restarts (0 = no time limit)
...
A3W_vehicleQuantity = 120;         // Approximate number of land vehicles to be spawned in towns
